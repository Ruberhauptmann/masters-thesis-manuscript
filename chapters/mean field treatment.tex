...
\chapter{Mean field treatment, multi-band BCS theory}

Introduced BCS theory in \cref{ch:superconductivitiy}, but EG-X has multiple band, this is the important factor for having quantum geometry.
