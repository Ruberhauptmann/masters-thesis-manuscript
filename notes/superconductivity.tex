...
\todo{GL energy with minimal coupling}
\begin{equation}
...
Can get the current density from the stationary point condition of the free energy for the vector potential \(\vb{A}\) \cite{colemanIntroductionManyBodyPhysics2015}:
\begin{equation}
...
\todo{Work over graphic for Landau OP}
\todo{Work over graphic for Landau current}
\begin{figure}[t]
	\centering
	\begin{subfigure}[b]{0.5\textwidth}
...
This \glsxtrshort{bcs} theory is one of the great successes in physics history.
