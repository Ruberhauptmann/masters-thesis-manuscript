...
\todo{Introduce mean field for BCS here}
...
Mean-field approximation (here specifically for superconductivity i.e. pairing): operators do not deviate much from their average value, i.e. the deviation operators \todo{correct definition}
\begin{align}
	d_{i, \alpha, \uparrow}^{\dagger} d_{i, \alpha, \downarrow} = c_{i, \alpha, \uparrow}^{\dagger} c_{i, \alpha, \downarrow} - \braket{c_{i, \alpha, \uparrow}^{\dagger} c_{i, \alpha, \downarrow}} \\
	d_{i, \alpha, \uparrow}^{\dagger} d_{i, \alpha, \downarrow} = c_{i, \alpha, \uparrow}^{\dagger} c_{i, \alpha, \downarrow} - \braket{c_{i, \alpha, \uparrow}^{\dagger} c_{i, \alpha, \downarrow}}
\end{align}
are small (dont contribute much to expectation values and correlation functions), so in
...
\begin{equation}
	c_{i, \alpha, \uparrow}^{\dagger} c_{i, \alpha, \downarrow}^{\dagger} c_{i, \alpha, \downarrow} c_{i, \alpha, \uparrow}
\end{equation}
...
\paragraph{Self-consistent Parameters}
