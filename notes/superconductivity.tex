...
Superconductivity as a phenomenon is very interesting.

Current technical applications often rely on the 
...
\todo{Some words: why is SC interesting?}
...
1986 and 1987: discovery of superconductivity with very high \(T_C\) found in cuprates \cite{bednorzPossibleHighTcSuperconductivity1986,uchidaHighTcSuperconductivity1987}.
Cuprate superconductors are  
\cite{rybickiPerspectivePhaseDiagram2016}
\todo{A bit more explanation what cuprates are}.

Theoretical description using BCS-theory based on an attractive interaction mediated by phonons could not explain this.
For this reason, the term `unconventional superconductors' for them.
...
This chapter: introduction to BCS theory in \cref{sec:bcs-theory} and GL-theory in \cref{sec:Ginzburg-Landau theory of superconductivity}.
