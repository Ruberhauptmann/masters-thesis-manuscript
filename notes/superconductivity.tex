...
\end{equation}
\todo{Introduce gradient term as kinetic energy (with mass)}
...
\todo{significance of coherence length: only phase fluctuations}
...
\todo{Explanation London penetration depth}

\todo{Explanation supercurrent}
...
\todo{Explanation: phase fluctuations destroy SC order -> introducing q gives access to SC properties}
