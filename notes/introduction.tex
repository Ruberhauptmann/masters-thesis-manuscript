...
\begin{figure}
	...
	\caption[Twisted Bilayer graphene.]{
		...
		\textbf{(\subref{sfig:unconventional SC MATBG})} Phase diagram of the twisted Bilayer graphene showing the dependence of \(T_{\mathrm{C}}\) on the carrier density in the partially filled flat band.
...
\Cref{ch:superconductivity} reviews aspects of the theoretical description of superconductors, in particular the Ginzburg-Landau theory which is the foundation for the \gls{fmp} method.
